...
describe('Checkout as a guest user registering an account during checkout - bank transfer', () => {
    ...
    it('User should be able to choose payment method - bank transfer', async () => {
        await Page.waitUntilPageLoaded();
        await CheckoutPage.choosePaymentMethod('bankwire');
    });
