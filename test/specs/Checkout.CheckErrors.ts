...
describe('Checkout as a logged in user using bank wire', () => {
    ...
    it('User should not be able to pass shipping method without confirming the agreements first', async () => {
        await CheckoutPage.checkAgreementsError();
    });
    it('User should be able to close the agreements error modal', async () => {
        await CheckoutPage.closeAgreementsError();
    });
