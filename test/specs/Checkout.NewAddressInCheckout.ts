...
describe('Checkout as a logged in user adding new address during checkout flow', () => {
    ...
    it('User should be able to proceed on adding new address', async () => {
        await Page.waitUntilPageLoaded();
        await CheckoutPage.addNewAddressInCheckout();
    });
    it('User should be able to add new address and go back in checkout flow', async () => {
        await Page.waitUntilPageLoaded();
